...
template <class T>
void cmatrix<T>::check_dim(const std::tuple<size_t, size_t> &dim) const
{
...
template <class T>
void cmatrix<T>::check_dim(const cmatrix<T> &m) const
{
    check_dim(m.dim());
}

template <class T>
void cmatrix<T>::check_valid_row(const std::vector<T> &row) const
{
    if (row.size() != dim_h())
...
template <class T>
void cmatrix<T>::check_valid_col(const std::vector<T> &col) const
{
    if (col.size() != dim_v())
...
template <class T>
void cmatrix<T>::check_valid_diag(const std::vector<T> &diag) const
{
...
template <class T>
void cmatrix<T>::check_valid_row_id(const size_t &n) const
{
    if (n < 0 || n >= dim_v())
...
template <class T>
void cmatrix<T>::check_valid_col_id(const size_t &n) const
{
    if (n < 0 || n >= dim_h())
...
template <class T>
void cmatrix<T>::check_expected_id(const size_t &n, const size_t &expectedBegin, const size_t &exepectedEnd) const
{
...
template <class T>
void cmatrix<T>::check_expected_id(const size_t &n, const size_t &expected) const
{
    check_expected_id(n, expected, expected);
}

template <class T>
void cmatrix<T>::check_valid_type() const
{
